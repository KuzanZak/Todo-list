...
class TaskController
{
    ...
    public function index()
    {
        ...
        $task->getAllNotDone();
        $view = new TaskList([
            'taskList' => implode('', array_map(fn ($t) => "<li><a href=\"action.php?action=done&id_task=" . $t["id_task"] . "\" class=\"list-checkbox\"><i class=\"fa fa-check-square icon\" aria-hidden=\"true\"></i></a>" . $t["description_task"] . "<span class=\"date-span\">" . getDateFromArray($t["date_reminder"]) . "</span>
